        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                    ...
                    Math.abs(v) < .4 && (v = 0), Math.abs(g) < .4 && (g = 0), Math.abs(h) < .4 && (h = 0), Math.abs(u) < .4 && (u = 0), Math.abs(m) < .4 && (m = 0), Math.abs(w) < .4 && (w = 0);
