  ...
  const question = [
    {
      ...
      answer:
        " Simply ensure your wallet is connected, select Create Token, fill in the required token details, pay a small fee (.4 Sol), and click Create Token.",
      id: "faq-1",
    },
    {
      question: " Are there more Solana Tools on the Way?",
      answer:
