...
const handleFeePayment = async () => {
                ...
                <div class="lg:ps-0 flex flex-col p-10">
                  <div class="pb6 my-auto ">
                    ...
                    <p class="text-default-300 mb-8 max-w-sm ">
                      Kindly provide all the details about your token. Create Button Will Be Enabled and Change Color After Fee Payment.
                    </p>
  ...
  >
    Pay 0.4 SOL Fee (Create Token Enabled After Payment)
  </button>
  <button
    ...
    type="submit"
  >
    <span class="fw-bold">Create Token (Click X below to Return to Home Page)</span>
  </button>
</div>
